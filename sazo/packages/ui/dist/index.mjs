...
function UIText(_a) {
  ...
  return /* @__PURE__ */ jsx(Element, __spreadValues({ id, className: classes }, rest));
}
function LargeTitle(_a) {
  ...
  return /* @__PURE__ */ jsx(UIText, __spreadValues({ element, weight, size }, rest));
}
function Title1(_a) {
  var _b = _a, {
    element = "h2",
...
function Headline(_a) {
  ...
  return /* @__PURE__ */ jsx(UIText, __spreadValues({ weight, size }, rest));
}
function Body(_a) {
  var _b = _a, {
    secondary = true,
  ...
  return /* @__PURE__ */ jsx(UIText, __spreadValues({ secondary, size }, rest));
}
function Caption(_a) {
  var _b = _a, {
    tertiary = true,
  ...
  return /* @__PURE__ */ jsx(UIText, __spreadValues({ tertiary, size }, rest));
}
...
function HomeIcon(props) {
  const _a = props, { size = 24 } = _a, rest = __objRest(_a, ["size"]);
  return /* @__PURE__ */ jsxs("svg", __spreadProps(__spreadValues({ width: size, height: size, fill: "none", viewBox: "0 0 24 24" }, rest), { children: [
    /* @__PURE__ */ jsx2(
      "path",
      {
        stroke: "currentColor",
...
function BookmarkIcon(props) {
  const _a = props, { size = 24 } = _a, rest = __objRest(_a, ["size"]);
  return /* @__PURE__ */ jsx2("svg", __spreadProps(__spreadValues({ width: size, height: size, fill: "none", viewBox: "0 0 24 24" }, rest), { children: /* @__PURE__ */ jsx2(
    "path",
    {
      stroke: "currentColor",
      strokeLinecap: "round",
...
function InformationIcon(props) {
  ...
  return /* @__PURE__ */ jsxs("svg", __spreadProps(__spreadValues({ width: size, height: size, fill: "none", viewBox: "0 0 24 24" }, rest), { children: [
    ...
    /* @__PURE__ */ jsx2("circle", { cx: "12", cy: "9", r: "1", fill: "currentColor" }),
    /* @__PURE__ */ jsx2(
      "circle",
      {
        cx: "12",
...
function TagIcon(props) {
  const _a = props, { size = 24 } = _a, rest = __objRest(_a, ["size"]);
  return /* @__PURE__ */ jsxs("svg", __spreadProps(__spreadValues({ width: size, height: size, fill: "none", viewBox: "0 0 24 24" }, rest), { children: [
    /* @__PURE__ */ jsx2("circle", { cx: "15", cy: "9", r: "1", fill: "currentColor" }),
    /* @__PURE__ */ jsx2(
      "path",
      {
        stroke: "currentColor",
...
function SlackIcon(props) {
  ...
  return /* @__PURE__ */ jsxs(
    "svg",
    {
      ...
      xmlns: "http://www.w3.org/2000/svg",
      children: [
        /* @__PURE__ */ jsxs("g", { clipPath: "url(#clip0_1841_4486)", children: [
          /* @__PURE__ */ jsx2(
            "path",
            {
        ...
        /* @__PURE__ */ jsx2("defs", { children: /* @__PURE__ */ jsx2("clipPath", { id: "clip0_1841_4486", children: /* @__PURE__ */ jsx2("rect", { width: "24", height: "24", fill: "white" }) }) })
      ]
    }
  );
}
function GoogleCalendarIcon(props) {
  ...
  return /* @__PURE__ */ jsxs(
    "svg",
    {
      ...
      xmlns: "http://www.w3.org/2000/svg",
      children: [
        /* @__PURE__ */ jsxs("g", { clipPath: "url(#clip0_1841_4477)", children: [
          /* @__PURE__ */ jsx2(
            "path",
            {
          ...
          /* @__PURE__ */ jsx2("path", { d: "M18.3154 24L23.9996 18.3158H18.3154V24Z", fill: "#EA4335" }),
          /* @__PURE__ */ jsx2(
            "path",
            {
          ...
          /* @__PURE__ */ jsx2("path", { d: "M18.3161 18.3158H5.68457V24H18.3161V18.3158Z", fill: "#34A853" }),
          /* @__PURE__ */ jsx2(
            "path",
            {
        ...
        /* @__PURE__ */ jsx2("defs", { children: /* @__PURE__ */ jsx2("clipPath", { id: "clip0_1841_4477", children: /* @__PURE__ */ jsx2("rect", { width: "24", height: "24", fill: "white" }) }) })
      ]
    }
  );
}
  ...
  if (!src) {
    ...
    return /* @__PURE__ */ jsx3(
      ...
      __spreadProps(__spreadValues({
        ...
        children: initials ? /* @__PURE__ */ jsx3("span", { className: "text-black text-opacity-60", children: /* @__PURE__ */ jsx3(
          UIText,
          {
            inherit: true,
        ...
        ) }) : /* @__PURE__ */ jsx3(UserIcon, { size: size * 0.75 })
      })
    );
  }
  return /* @__PURE__ */ jsx3(
...
function Logo({ mode = "light" }) {
  if (mode === "dark") {
    return /* @__PURE__ */ jsx4(Fragment, { children: /* @__PURE__ */ jsxs2(
      "svg",
      {
        xmlns: "http://www.w3.org/2000/svg",
        width: "120",
        ...
        viewBox: "0 0 160 40",
        children: [
          /* @__PURE__ */ jsxs2("g", { clipPath: "url(#clip0_1011_3450)", children: [
            /* @__PURE__ */ jsx4(
              "path",
              {
                fill: "#8b5cf6",
          ...
          /* @__PURE__ */ jsx4("defs", { children: /* @__PURE__ */ jsx4("clipPath", { id: "clip0_1011_3450", children: /* @__PURE__ */ jsx4("path", { fill: "#fff", d: "M0 0H160V39.47H0z" }) }) })
        ]
      }
    ) });
  }
...
var UnstyledLink = memo(
  forwardRef(function UnstyledLink2(props, _ref) {
    ...
    if (external) {
      return /* @__PURE__ */ jsx7("a", __spreadProps(__spreadValues({ target }, rest), { href: url, rel }));
    }
    return /* @__PURE__ */ jsx7(Link, { href: url, legacyBehavior: true, children: /* @__PURE__ */ jsx7("a", __spreadProps(__spreadValues({ target }, rest), { rel })) });
  })
);
...
function UnstyledButton(_a) {
  ...
  if (url) {
    buttonMarkup = disabled ? /* @__PURE__ */ jsx8("a", __spreadProps(__spreadValues({}, commonProps), { children })) : /* @__PURE__ */ jsx8(
      UnstyledLink,
...
function Button({
  ...
  const childMarkup = children ? /* @__PURE__ */ jsx9("span", { children }, disabled ? "text-disabled" : "text") : null;
  ...
  const spinnerSVGMarkup = loading ? /* @__PURE__ */ jsx9(LoadingSpinner, {}) : null;
  const commonClasses = classnames2(
  ...
  const buttonMarkup = /* @__PURE__ */ jsx9(UnstyledButton, __spreadProps(__spreadValues(__spreadValues(__spreadValues({}, commonProps), linkProps), actionProps), { children: /* @__PURE__ */ jsx9(
    conditionalWrap_default,
    {
      condition: !!leadingIcon || !!trailingIcon || !!loading,
      wrap: (children2) => /* @__PURE__ */ jsx9(
        "span",
        {
  ...
  return /* @__PURE__ */ jsx9(
    ...
    {
      condition: !!tooltip,
      wrap: (children2) => /* @__PURE__ */ jsx9(Tooltip, { label: tooltip, children: /* @__PURE__ */ jsx9("span", { children: children2 }) }),
...
function Table(props) {
  ...
  return /* @__PURE__ */ jsx10("div", { className: "divide-y divide-neutral-150", children });
}
function TableRow(props) {
  const { children } = props;
  return /* @__PURE__ */ jsx10("div", { className: "flex flex-col items-start p-4 space-x-0 space-y-3 sm:space-y-0 sm:space-x-4 sm:items-center sm:flex-row", children });
}
...
function DialogOverlay() {
  return /* @__PURE__ */ jsx12(
    Transition2.Child,
    {
      ...
      leaveTo: "opacity-0",
      children: /* @__PURE__ */ jsx12("div", { className: "fixed inset-0 bg-black bg-opacity-20" })
    }
  );
}

// src/Dialog/index.tsx
import { Dialog as D, Transition as Transition3 } from "@headlessui/react";
import { Fragment as Fragment6, useRef } from "react";
...
function Dialog(props) {
  ...
  return /* @__PURE__ */ jsx13(Transition3, { appear: true, show: isVisible, as: Fragment6, children: /* @__PURE__ */ jsxs6(
    D,
    {
      as: "div",
      ...
      children: [
        ...
        /* @__PURE__ */ jsx13("div", { className: "fixed inset-0", children: /* @__PURE__ */ jsx13("div", { className: "flex items-center justify-center min-h-full p-4", children: /* @__PURE__ */ jsx13(DialogTransitionContainer, { children: /* @__PURE__ */ jsx13(
          D.Panel,
          {
            ...
            children: /* @__PURE__ */ jsxs6("div", { className: "flex flex-col max-h-[calc(100vh-32px)] gap-3", children: [
              /* @__PURE__ */ jsxs6("div", { className: "sticky top-0 z-10 flex flex-col px-3 pt-3 bg-white rounded-t-lg", children: [
                /* @__PURE__ */ jsxs6("div", { className: "flex items-center justify-between", children: [
                  /* @__PURE__ */ jsx13(D.Title, { as: "h3", className: "text-md font-medium", children: title }),
                  /* @__PURE__ */ jsx13(
                    "button",
                    {
                      ref: closeButtonRef,
                ...
                description && /* @__PURE__ */ jsx13(D.Description, { className: "w-[80%] -mt-1 text-sm text-neutral-500", children: description })
              ] }),
              children
            ] })
          }
...
function DialogContentContainer(props) {
  return /* @__PURE__ */ jsx13("div", __spreadValues({ className: "px-3" }, props));
}
...
function FormError(props) {
  ...
  if (!children)
    return null;
  return /* @__PURE__ */ jsx14("p", { className: "pl-2 text-sm text-left text-red-600 border-l-2 border-red-600", children });
}
function MutationError(props) {
  ...
  if (!isValid)
    return null;
  return /* @__PURE__ */ jsx14(Fragment7, { children: mutation.error.message });
}
...
function ActionMenu(props) {
  ...
  const defaultTrigger = trigger ? trigger : /* @__PURE__ */ jsx15("div", { className: "rounded-full", children: /* @__PURE__ */ jsx15(DotsHorizontal, { size: 32 }) });
  return /* @__PURE__ */ jsx15(Menu, { as: "div", className: "relative", children: /* @__PURE__ */ jsxs7(
    Float,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx15(Menu.Items, { className: "z-30 origin-top-right bg-white rounded-lg shadow-md w-44 ring-1 ring-black ring-opacity-5 focus:outline-none", children: /* @__PURE__ */ jsx15("div", { className: "flex flex-col px-1 py-1", children: actions.map((action, index) => {
          if (action.separator)
            return /* @__PURE__ */ jsx15(ActionMenuSeparator, {}, `separator-${index}`);
          return /* @__PURE__ */ jsx15(ActionMenuItem, { action }, action.label);
        }) }) })
      ]
    }
  ) });
}
var MenuItemLink = forwardRef2(
  (props, ref) => {
    let { href, children, external, className } = props;
    const target = external ? "_blank" : void 0;
    const rel = external ? "noopener noreferrer" : void 0;
    return /* @__PURE__ */ jsx15(Link2, { href, legacyBehavior: true, children: /* @__PURE__ */ jsx15("a", { ref, target, rel, className, children }) });
  }
);
...
function ActionMenuItem(props) {
  ...
  return /* @__PURE__ */ jsx15(Menu.Item, { disabled, children: ({ active }) => {
    ...
    return url ? /* @__PURE__ */ jsxs7(MenuItemLink, { className: classes, href: url, children: [
      icon && /* @__PURE__ */ jsx15("span", { children: icon }),
      " ",
      /* @__PURE__ */ jsx15("span", { children: label })
    ] }) : /* @__PURE__ */ jsxs7("button", { className: classes, onClick, type: "button", children: [
      icon && /* @__PURE__ */ jsx15("span", { children: icon }),
      " ",
      /* @__PURE__ */ jsx15("span", { children: label })
    ] });
...
function ActionMenuSeparator() {
  return /* @__PURE__ */ jsx15("div", { className: "h-px my-1 -mx-1 bg-neutral-200" });
}

// src/ListBox/index.tsx
import { Listbox, Transition as Transition5 } from "@headlessui/react";
import classNames2 from "classnames";
import { Fragment as Fragment8, useState as useState4 } from "react";
import { Fragment as Fragment9, jsx as jsx16, jsxs as jsxs8 } from "react/jsx-runtime";
function ListBox(props) {
  ...
  const [selected, setSelected] = useState4(defaultOption);
  ...
  return /* @__PURE__ */ jsx16(Listbox, { disabled, value: selected.value, onChange: handleChange, children: /* @__PURE__ */ jsxs8("div", { className: "relative", children: [
    /* @__PURE__ */ jsx16(
      Listbox.Button,
      {
        ...
        children: /* @__PURE__ */ jsxs8(Fragment9, { children: [
          ...
          /* @__PURE__ */ jsx16("span", { className: "block truncate", children: selected.label }),
          /* @__PURE__ */ jsx16("span", { className: "absolute inset-y-0 right-0 flex items-center pr-1 text-black text-opacity-50 pointer-events-none", children: /* @__PURE__ */ jsx16(ChevronDownIcon, { "aria-hidden": "true" }) })
        ] })
      }
    ),
    /* @__PURE__ */ jsx16(
      Transition5,
      {
        ...
        appear: true,
        children: /* @__PURE__ */ jsx16(Listbox.Options, { className: "absolute z-10 w-full p-1 py-1 mt-1 overflow-auto text-sm bg-white rounded-md shadow-lg max-h-60 ring-1 ring-black ring-opacity-5 focus-visible:outline-none sm:text-sm", children: options.map((option, index) => /* @__PURE__ */ jsx16(
          Listbox.Option,
          {
            ...
            value: option.value,
            title: option.label,
            children: ({ selected: selected2 }) => /* @__PURE__ */ jsxs8(Fragment9, { children: [
              /* @__PURE__ */ jsxs8("span", { className: `flex items-center space-x-2`, children: [
                option.leadingAccessory && option.leadingAccessory,
                /* @__PURE__ */ jsx16("span", { className: "truncate", children: option.label })
              ] }),
              selected2 ? /* @__PURE__ */ jsx16("span", { className: "absolute inset-y-0 left-0 flex items-center pl-2", children: /* @__PURE__ */ jsx16(CheckIcon, { "aria-hidden": "true" }) }) : null
            ] })
          },
...
function TextField(props) {
  ...
  const labelMarkup = label ? /* @__PURE__ */ jsx17(
    UIText,
    {
      className: classnames4("mb-1 text-zinc-900", {
        "sr-only": labelHidden
      }),
      weight: "font-medium",
      size: "text-xs",
  ...
  const prefixMarkup = prefix ? /* @__PURE__ */ jsx17("div", { className: "flex items-center p-2 border border-r-0 rounded-l-md bg-neutral-50 border-neutral-200", children: /* @__PURE__ */ jsx17(UIText, { tertiary: true, children: prefix }) }) : null;
  const helpMarkup = helpText ? /* @__PURE__ */ jsx17(Caption, { tertiary: true, className: "mt-2", children: helpText }) : null;
  const errorMarkup = inlineError ? /* @__PURE__ */ jsx17(UIText, { className: "pl-3 mt-2 text-red-600 border-l-2 border-red-600", children: inlineError }) : null;
  const copyMarkup = clickToCopy ? /* @__PURE__ */ jsx17(Tooltip, { placement: "top", label: "Copy", children: /* @__PURE__ */ jsx17("span", { className: "absolute -translate-y-1/2 right-2 top-1/2", children: /* @__PURE__ */ jsx17(
    Button,
    {
      onClick: handleCopyClick,
      plain: true,
      leadingIcon: /* @__PURE__ */ jsx17(ClipboardIcon, {}),
      iconOnly: true
    }
  ) }) }) : null;
  const inputClasses = classnames4(
  ...
  const inputMarkup = multiline ? /* @__PURE__ */ jsx17(
    TextareaAutosize,
    {
      id,
      name,
  ...
  return /* @__PURE__ */ jsxs9("div", { className: `relative flex flex-col ${colSpan}`, children: [
    labelMarkup,
    /* @__PURE__ */ jsxs9("div", { className: "relative flex flex-1", children: [
      prefixMarkup,
      inputMarkup,
      copyMarkup
    ] }),
