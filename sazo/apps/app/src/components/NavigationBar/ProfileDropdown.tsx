                        ...
                        <div className="px-1 py-1">
                            <Menu.Item>
                                {({ active }) => (
                                    <SettingsLink
                                        ...
                                        "group flex w-full text-sm items-center rounded px-1 space-x-1 py-1 normal-case",
                                        {
                                            "bg-violet-100 text-violet-900": active,
                                            "text-neutral-900": !active,
                                        }
                                    )}
                                    >
                                        <UserCircleIcon />
                                        <UIText inherit>My profile</UIText>
                                    </SettingsLink>
                                )}
                            </Menu.Item>
                            ...
                            <Menu.Item>
                                {({ active }) => (
                                    ...
                                    >
                                        <GearIcon />
                                        <UIText inherit>Profiel instellingen</UIText>
                                    </SettingsLink>
                                )}
                            </Menu.Item>

                            <div className="h-px my-1 -mx-1 bg-neutral-200" />
                            <Menu.Item>
                                {({ active }) => (
                                    <button
                                        onClick={() => logout()}
